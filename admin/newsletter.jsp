...
<div class="wrapper">
	<jsp:include page="/admin/hnav.jsp">
		<jsp:param value="news" name="form"/>
	</jsp:include>
          		...
          		<div class="row">
          			...
          			<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
			              ...
			              <div class="card-header">
			                <h3 class="card-title">List of subscribers enrolled for Newsletter</h3>
			              </div>
			              <div class="card-body">
			                ...
			                <%
		                    	...
		                    	result = stmt.executeQuery("SELECT idsubscriber, mail_id, date_format(created_date,'%d-%m-%Y') as 'date',`active` FROM subscriber;");
		                    	while(result.next()){
			                %>  
			                  <tr>
			                    <td><%= result.getString("idsubscriber") %></td>
